...
class ConfigActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        config?.let {
            binding!!.etRemarks.text = Utils.getEditable(it.remarks)
            binding!!.etAddress.text = Utils.getEditable(it.ipaddr)
            binding!!.etPort.text = Utils.getEditable(it.port.toString())
            binding!!.spNettype.setSelection(config.netType)
            binding!!.spFilterApp.setSelection(config.filterType)
...
//                toast(R.string.server_lab_address)
            ...
            config.filterType = it.spFilterApp.selectedItemPosition
        }
